...
class ReflexCaptureAgent(CaptureAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for nextAction in self.get_legal_actions(state):
    ...
    def choose_action(self, game_state):
        ...
        """
        legalActions = self.get_legal_actions(game_state)
        action = None
...
class OffensiveReflexAgent(ReflexCaptureAgent):
    ...
    def __init__(self, index, time_for_computing=.1):
        super().__init__(index, time_for_computing)
        self.values = util.Counter()  # Initialize the values attribute
        self.epsilon = 0.8  # Set the value of epsilon

    def get_legal_actions(self, state):
        """
        Returns a list of legal actions for the agent in the given state.
        """
